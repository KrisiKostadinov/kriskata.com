      ...
      <div className="container mx-auto grid lg:grid-cols-2 items-center lg:gap-10 px-5">
        <div className="text-lg max-lg:text-center py-5 md:py-10 space-y-6 max-md:px-5 max-lg:order-2">
          ...
          <p>
            ...
            достатъчно място за всичките файлове на сайта, изпращане и
            получаване на имейли, база данни и качване на файлове. След
            изтичането на безплатния период можете да решите дали да подновите
            услугата или да преминете към по-висок хостинг план, след като
            бизнесът Ви се развие достатъчно много.
          </p>
        </div>
        <Image
